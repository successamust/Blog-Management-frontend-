...
const Posts = () => {
  ...
  const [loading, setLoading] = useState(!(initialPostsData?.posts?.length > 0));
  const [pagination, setPagination] = useState({
    currentPage: initialPostsData?.pagination?.currentPage || 1,
    totalPages: initialPostsData?.pagination?.totalPages || 1,
    totalPosts: initialPostsData?.pagination?.totalPosts || 0,
    limit: initialPostsData?.pagination?.limit || 12,
  });
